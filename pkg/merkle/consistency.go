...
func VerifyConsistencyProof(m, n int, oldRoot, newRoot []byte, proof *ConsistencyProof, hashFunc HashFunc) bool {
	if hashFunc == nil {
...
func verifySubProof(m, n int, b bool, proofHashes [][]byte, oldRoot []byte, hashFunc HashFunc) ([]byte, []byte, [][]byte, error) {
