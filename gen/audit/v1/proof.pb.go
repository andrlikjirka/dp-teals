...
func (x *GetLatestSignedCheckpointResponse) GetSignature() *Signature {
	if x != nil {
		return x.Signature
	}
	return nil
...
type Signature struct {
	...
	SignatureToken string                 `protobuf:"bytes,2,opt,name=signature_token,json=signatureToken,proto3" json:"signature_token,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *Signature) GetSignatureToken() string {
	if x != nil {
...
const file_audit_v1_proof_proto_rawDesc = "" +
	...
	"\x0fsignature_token\x18\x02 \x01(\tR\x0esignatureToken\"-\n" +
