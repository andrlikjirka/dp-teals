...
type CheckpointWorker struct {
	service  service.CheckpointCreator
...
func NewCheckpointWorker(service service.CheckpointCreator, interval time.Duration, logger *logger.Logger) *CheckpointWorker {
